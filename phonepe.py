...
from sqlalchemy import create_engine  # SQLAlchemy for creating an engine
...
# Create an SQLAlchemy engine for data insertion and interaction
...
st.set_page_config(page_title='PHONEPE PULSE',page_icon=icon,initial_sidebar_state='expanded',
                        layout='wide',menu_items={"about":'This streamlit application was developed by Fran Lizza'})
...
if selected == "ABOUT":
        ...
        st.markdown('''<h5>Hello! I'm Fran Lizza, a BE graduate with a keen interest in data science and analytics.
                Currently on an exciting journey into the world of data science...''',unsafe_allow_html=True)
        st.link_button('Linkedin','www.linkedin.com/in/fran-lizza-m-07b168132/') 
